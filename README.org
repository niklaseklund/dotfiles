...
My dotfiles for [[My dotfiles, stored and managed with Emacs, using %5B%5Bhttps://orgmode.org/%5D%5BOrg mode%5D%5D.][Arch Linux]] and [[https://ubuntu.com/][Ubuntu]], organized and managed through [[https://www.gnu.org/software/emacs/][Emacs]] and
